...
constructor(props){
  super(props);
  console.log("inside constructor for PostsNew:",props);
  this.props.custommethod();// Call the method from simpletabs.js
}
...
onFormSubmit(values) {
  ...
  //  this.props.createPost(values,()=>{this.props.history.push('/')});//
    this.props.createPost(values,()=>{
      ...
      this.props.resetForm(); //Reset/Blank the form values
    });
    // Call the function in action index.js file
...
*/
  render(){
    ...
    */
    ...
    // );
    return(
      <form name='myForm' onSubmit={handleSubmit(this.onFormSubmit.bind(this))}>
        <Field name="title" component={this.renderField} labelToShow="Title for Post"/>
        <Field name="categories" component={this.renderField} labelToShow="Categories"/>
        <Field name="content" component={this.renderField} labelToShow="Post Content"/>
        <button type="submit" className="btn btn-primary">Submit</button>
